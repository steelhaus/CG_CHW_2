...
void CParticleSystemTransformFeedback::AddGeneratorPosition(glm::vec3 a_vGenAddPosition){
	vGenPosition += a_vGenAddPosition;
}

void CParticleSystemTransformFeedback::SetGenColor(glm::vec3 a_vGenColor){
	vGenColor = a_vGenColor;
}

void CParticleSystemTransformFeedback::setGenVelocity(glm::vec3 a_vGenVelocityMin, glm::vec3 a_vGenVelocityMax){
